...
const RepseIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="16" rx="3"/><path d="M3 10h18"/><path d="M9 14h2"/><path d="M9 17h6"/></svg>
);
...
function AdminSidebar({
  ...
  const menuItems: Array<{
    ...
    { name: "REPSE", href: "/repse", icon: <RepseIcon />, modulo: "repse" },
    ...
    <html lang="es">
      <head>
        ...
        <link
          ...
          href="/apple-touch-icon-admin.png?v=9"
          sizes="180x180"
          media="(prefers-color-scheme: light)"
        />
        <link
          rel="apple-touch-icon"
          href="/apple-touch-icon-admin-dark.png?v=9"
          sizes="180x180"
          media="(prefers-color-scheme: dark)"
        />
        <link rel="apple-touch-icon" href="/apple-touch-icon-admin.png?v=9" sizes="180x180" />
