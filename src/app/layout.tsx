    ...
    return (
      <html lang="es-MX" className={fontVariables}>
        <head>
          ...
          <link rel="apple-touch-icon" href="/apple-touch-icon-v2.png?v=17" sizes="180x180" />
          <link
            rel="icon"
            type="image/png"
            sizes="32x32"
  ...
  return (
    <html lang="es-MX" className={fontVariables}>
      <head>
        ...
        <link rel="apple-touch-icon" href="/apple-touch-icon-admin-v2.png?v=17" sizes="180x180" />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"
