        ...
        <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0a0a0c] shadow-[0_30px_80px_-30px_rgba(124,58,237,0.55)]">
          ...
          <div className="relative flex flex-col items-center gap-9 py-12 pl-14 pr-8 text-center sm:py-16 sm:pl-24 sm:pr-12 lg:flex-row lg:gap-12 lg:text-left">
            ...
            <div className="relative shrink-0">
              <div
                className="absolute left-1/2 top-1/2 h-56 w-56 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-[#9333ea]/50 via-[#e21bd1]/50 to-[#ff0a78]/50 blur-3xl sm:h-72 sm:w-72"
                aria-hidden="true"
              />
              <div
