...
const FILAS: Fila[] = [
  ...
  },
  {
    ...
    tradicional:
      "Un auxiliar diferente cada vez. Tienes que explicar todo de nuevo",
    rdc: "Tu propio contador asignado. Conoce tu negocio desde el día 1",
  },
  {
          ...
          <div className="relative isolate overflow-hidden rounded-3xl bg-gradient-to-br from-marca-navy-deep via-marca-navy to-indigo-950 text-white p-8 sm:p-12 shadow-2xl">
            ...
            <div className="relative max-w-2xl">
              ...
              <p className="mt-4 text-slate-300 leading-relaxed">
                Te atendemos directamente, sin llamadas en espera ni marcar
                extensiones. En la primera conversación te decimos qué
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <a
                  href={CONTACTO_PUBLICO.whatsapp.buildUrl(
                    "Hola, vengo de la comparativa de su sitio. Quiero saber qué necesito para cambiarme con ustedes."
                  )}
                  target="_blank"
