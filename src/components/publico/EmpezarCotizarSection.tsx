    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-6 xl:gap-8 items-start min-h-[calc(100dvh-11rem)]">
      ...
      <div className="w-full max-w-xl mx-auto lg:mx-0 lg:max-w-none">
        {!testAbierto ? (
          ...
          >
            ...
            <div className="relative flex flex-col items-center justify-center gap-5 px-6 py-10 sm:py-12 h-full">
              <div className="relative max-w-[17rem] sm:max-w-xs">
                <div className="rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-600 text-white px-4 py-3.5 shadow-lg shadow-violet-300/50 ring-1 ring-white/20">
                  ...
                  <p className="mt-1.5 text-xs text-indigo-100/95 leading-snug">
                    Solo marca lo que te suene y veamos cómo andas con tus
                    impuestos.
                  </p>
                </div>
                <span
          ...
          <div className="flex flex-col gap-2.5 empezar-test-enter">
