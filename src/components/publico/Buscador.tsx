...
const COMANDOS: Comando[] = [
  ...
  {
    id: "h-facturacion",
    titulo: "Calculadora de Facturación",
    subtitulo: "Neto deseado → subtotal, IVA y retenciones",
    tags: "facturacion cfdi neto retenciones isr iva resico pfae honorarios arrendamiento cuanto facturar",
    categoria: "herramientas",
    color: "indigo",
