...
export default function PortalShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      {cliente ? (
        <div className="hidden lg:flex fixed top-2 right-5 z-40 items-center">
          <NotificacionesBell
            destinatario="cliente"
            clienteId={cliente.id}
            tamano="sm"
      ...
      <main className="flex-1 w-full min-w-0 max-w-full overflow-x-hidden pt-16 lg:pt-6 lg:ml-64 lg:w-auto lg:max-w-[calc(100vw-16rem)] px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8 min-h-screen">
        {children}
