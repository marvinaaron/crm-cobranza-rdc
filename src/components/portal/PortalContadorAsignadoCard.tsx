        ...
        <div className="flex flex-wrap items-center gap-2 mt-3">
          {contador.email && (
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[var(--portal-navy-soft)] hover:bg-[var(--portal-navy-muted)] text-[var(--portal-navy)] text-[11px] font-black uppercase tracking-widest transition-colors"
            >
