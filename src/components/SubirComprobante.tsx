        ...
        <div className="space-y-3 rounded-2xl border border-indigo-200 bg-indigo-50/50 p-4">
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              ...
              className="flex-1 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-[10px] font-black uppercase tracking-widest hover:opacity-95 disabled:opacity-60 transition-all"
            >
          ...
          className={`w-full rounded-2xl border-2 border-dashed cursor-pointer select-none transition-all ${
            subiendo
              ...
              : arrastrando
                ...
                : "border-indigo-200 bg-gradient-to-r from-blue-50 to-indigo-50 hover:border-indigo-400 hover:from-blue-100 hover:to-indigo-100"
          }`}
        >
          <div className="flex flex-col items-center justify-center gap-1.5 py-5 px-4 text-center">
            ...
            <p
              className={`text-[11px] font-black uppercase tracking-widest ${
                arrastrando ? "text-indigo-700" : "text-indigo-700"
              }`}
            >
              {arrastrando
